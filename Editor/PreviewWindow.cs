...
namespace MicroLight.MultiView
{
    namespace UI
    {
        public static class PreviewWindow
        {
            ...
            [MenuItem("MicroLight/Toggle Preview %e", false, 1)]
            public static void ToggleWindow()
            {
                ...
                gameView.maxSize = new Vector2(MultiViewRenderManager.Instance.screenW*2, MultiViewRenderManager.Instance.screenH + tabSize);
                ...
                {
                    if (displayTexts[i].Contains("Free Aspect"))
                    {
                        index = i;
                        break;
                    }
                ...
                if (index == 0)
                {
                    Debug.LogWarning("couldn't find standalone resolution in preview window");
                }
            ...
            static EditorWindow GetMainGameView()
            {
                ...
                System.Reflection.MethodInfo GetMainGameView = T.GetMethod("GetMainGameView", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
            ...
            {
                EditorPrefs.SetFloat("MicroLight-preview-pos-x1", position.x);
                EditorPrefs.SetFloat("MicroLight-preview-pos-y1", position.y);
            }
            ...
            public static void LoadSettings()
            {
                float x = -2560;
                float y = 0;
                if (MultiViewRenderManager.Instance != null)
                {
                    x = -MultiViewRenderManager.Instance.screenW;
                    y = Screen.currentResolution.height - MultiViewRenderManager.Instance.screenH;
                }
                position = new Vector2
                (
                    EditorPrefs.GetFloat("MicroLight-preview-pos-x1", x),
                    EditorPrefs.GetFloat("MicroLight-preview-pos-y1", y)
                );
            }
        ...
        public class PreviewWindowEditor : EditorWindow
        {
            ...
            [MenuItem("MicroLight/Preview Settings %#e", false, 2)]
            static void Init()
            {
            ...
            void OnGUI()
            {
                ...
                if (left)
                {
                    PreviewWindow.position = new Vector2(-MultiViewRenderManager.Instance.screenW, 0);
                ...
                if (lowerLeft)
                {
                    PreviewWindow.position = new Vector2(-MultiViewRenderManager.Instance.screenW, Screen.currentResolution.height - MultiViewRenderManager.Instance.screenH);
                    EditorGUI.FocusTextInControl("");
                    PreviewWindow.SaveSettings();
                }
                ...
                if (lowerRight)
                {
                    PreviewWindow.position = new Vector2(Screen.currentResolution.width, Screen.currentResolution.height - MultiViewRenderManager.Instance.screenH);
                    EditorGUI.FocusTextInControl("");
                    PreviewWindow.SaveSettings();
                }
                ...
                {
                    EditorApplication.ExecuteMenuItem("MicroLight/Toggle Preview");
                    PreviewWindow.SaveSettings();
                }
                ...
                (
                    "Note: keeping your MicroLight Preview Window to the left is recommended. " +
                ...
                if (MultiViewRenderManager.Instance != null)
                {
                    ...
                    lkgDisplay.width = MultiViewRenderManager.Instance.screenW * factor;
                    lkgDisplay.height = MultiViewRenderManager.Instance.screenH * factor;
                    ...
                    lkgDisplay.x += 4;
                    lkgDisplay.y += 2;
                    GUI.Label(lkgDisplay, "MicroLight\ndisplay", EditorStyles.whiteMiniLabel);
